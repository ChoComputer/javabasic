...
public class PointTest05 {
	public static void main(String []args) {
		...
		System.out.println(num); // a && b 에서 a가 flase이 기때문에 b는 계산도  안함 그래서 10이나옴
		
		System.out.println(num<20 && num++ % 2 == 0);
		System.out.println(num); // a && b 에서 a가 true 여서 b까지 계산을 하여 num이 11이 됨!
